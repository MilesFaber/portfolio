		...
		<div id="list-admin" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="identification" title="${message(code: 'admin.identification.label', default: 'Identification')}" />
				...
				<g:each in="${adminInstanceList}" status="i" var="adminInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: adminInstance, field: "identification")}</td>
