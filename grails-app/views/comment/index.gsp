		...
		<div id="list-comment" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="comment.poster.label" default="Poster" /></th>
				...
				<g:each in="${commentInstanceList}" status="i" var="commentInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: commentInstance, field: "date")}</td>
					
						<td>${fieldValue(bean: commentInstance, field: "poster")}</td>
