		...
		<div id="list-country" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="locale" title="${message(code: 'country.locale.label', default: 'Locale')}" />
				...
				<g:each in="${countryInstanceList}" status="i" var="countryInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${countryInstance.id}">${fieldValue(bean: countryInstance, field: "locale")}</g:link></td>
