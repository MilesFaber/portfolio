	...
	<body>
		...
		<div id="show-message" class="content scaffold-show" role="main">
			...
			<ol class="property-list message">
				...
				<g:if test="${messageInstance?.articles}">
				<li class="fieldcontain">
					<span id="articles-label" class="property-label"><g:message code="message.articles.label" default="Articles" /></span>
					
						<g:each in="${messageInstance.articles}" var="a">
				...
				<g:if test="${messageInstance?.receiver}">
				<li class="fieldcontain">
					<span id="receiver-label" class="property-label"><g:message code="message.receiver.label" default="Receiver" /></span>
					
						<span class="property-value" aria-labelledby="receiver-label"><g:link controller="user" action="show" id="${messageInstance?.receiver?.id}">${messageInstance?.receiver?.encodeAsHTML()}</g:link></span>
					
				</li>
				</g:if>
			
				<g:if test="${messageInstance?.sendDate}">
				<li class="fieldcontain">
					<span id="sendDate-label" class="property-label"><g:message code="message.sendDate.label" default="Send Date" /></span>
					
						<span class="property-value" aria-labelledby="sendDate-label"><g:fieldValue bean="${messageInstance}" field="sendDate"/></span>
