		...
		<div id="list-message" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="message.receiver.label" default="Receiver" /></th>
					
						<g:sortableColumn property="sendDate" title="${message(code: 'message.sendDate.label', default: 'Send Date')}" />
				...
				<g:each in="${messageInstanceList}" status="i" var="messageInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: messageInstance, field: "sendDate")}</td>
