	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.identification}">
				<li class="fieldcontain">
					<span id="identification-label" class="property-label"><g:message code="user.identification.label" default="Identification" /></span>
					
						<span class="property-value" aria-labelledby="identification-label"><g:fieldValue bean="${userInstance}" field="identification"/></span>
				...
				<g:if test="${userInstance?.inbox}">
				<li class="fieldcontain">
					<span id="inbox-label" class="property-label"><g:message code="user.inbox.label" default="Inbox" /></span>
				...
				<g:if test="${userInstance?.outbox}">
				<li class="fieldcontain">
					<span id="outbox-label" class="property-label"><g:message code="user.outbox.label" default="Outbox" /></span>
