...
class AlertControllerSpec extends Specification {
    ...
    def populateValidParams(params) {
        ...
        def alertArticle = new Article(filePath:'filePath.txt', source:'articleSource', type:'articleType',
        	link:'http://articleLink', identification:'articleID', created_at: (new Date()).getTime())
        params["article"] = alertArticle
