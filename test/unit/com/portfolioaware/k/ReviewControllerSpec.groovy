...
class ReviewControllerSpec extends Specification {
    ...
    def populateValidParams(params) {
        ...
        def reviewRisk= new Risk( risk:'.5', assetAmount:'1000.', probability:'.5', reviewDate:(new Date()).getTime())
        params["risk"] = reviewRisk
        def reviewer= new Manager(name:'Bob Marley', identification:'ManagerID-319')
